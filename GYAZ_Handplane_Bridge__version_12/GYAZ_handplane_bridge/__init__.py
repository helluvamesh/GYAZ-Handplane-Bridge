...
class GYAZ_Export_Preferences (AddonPreferences):
    ...
    check_for_second_uv_map = BoolProperty (name='Check for 2nd UV Map', default=True, description='Check for 2nd uv map when exporting static meshes')
